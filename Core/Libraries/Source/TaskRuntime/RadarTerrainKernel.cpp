...
static unsigned radarTerrainBytesPerPixelForFormat(unsigned formatCode)
{
	...
	case RADAR_TERRAIN_FORMAT_X8L8V8U8:
		return 4;
	...
	case RADAR_TERRAIN_FORMAT_A8P8:
	case RADAR_TERRAIN_FORMAT_A8L8:
	case RADAR_TERRAIN_FORMAT_U8V8:
	case RADAR_TERRAIN_FORMAT_L6V5U5:
		return 2;

	case RADAR_TERRAIN_FORMAT_R3G3B2:
	case RADAR_TERRAIN_FORMAT_A8:
	case RADAR_TERRAIN_FORMAT_P8:
