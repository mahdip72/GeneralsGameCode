...
/*
** Enum for possible surface formats.  The values are a stable logical
** contract shared by loaders, CPU conversion, and native render resources.
** NOTE: Whenever this is changed, formconv.h/.cpp must be modified as well.
**
** The format names use the historical channel conventions:
**      A = Alpha
**      R = Red
**      G = Green
**      B = Blue
