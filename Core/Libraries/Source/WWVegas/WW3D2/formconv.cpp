...
** logical WW3D format remains the source of truth; D3D11 receives either an
** exact neutral format or the explicit BGRA8 upload format used by the CPU
** conversion path.  In particular, compressed and packed legacy formats are
** never advertised as native D3D11 resources.
*/
static const WW3DFormatDescriptor WW3DFormatDescriptorTable[WW3D_FORMAT_COUNT] =
{
	...
	{ WW3D_FORMAT_R8G8B8, 3, 1, 1, 3,
		WW3D_FORMAT_DESCRIPTOR_D3D11_CPU_CONVERSION,
		rts::render::RENDER_FORMAT_B8G8R8A8_UNORM },
	{ WW3D_FORMAT_A8R8G8B8, 4, 1, 1, 4,
		WW3D_FORMAT_DESCRIPTOR_D3D11_NATIVE,
		rts::render::RENDER_FORMAT_B8G8R8A8_UNORM },
	...
	rts::render::RenderFormat *renderFormat, bool *requiresCpuConversion)
{
	...
	*renderFormat = descriptor.d3d11Format;
	if (requiresCpuConversion != 0)
		*requiresCpuConversion =
			(descriptor.flags & WW3D_FORMAT_DESCRIPTOR_D3D11_CPU_CONVERSION) != 0;
	return descriptor.d3d11Format != rts::render::RENDER_FORMAT_UNKNOWN;
}
