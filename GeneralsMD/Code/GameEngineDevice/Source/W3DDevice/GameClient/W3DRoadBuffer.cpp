...
void RoadType::loadTexture(AsciiString path, Int ID)
{
	...
	m_vertexRoad=NEW_REF(DX8VertexBufferClass,(rts::render::GAME_VERTEX_XYZDUV1,TheGlobalData->m_maxRoadVertex+4, (s_dynamic?DX8VertexBufferClass::USAGE_DYNAMIC:DX8VertexBufferClass::USAGE_DEFAULT)));
...
void W3DRoadBuffer::loadRoadsInVertexAndIndexBuffers()
{
	...
	DX8IndexBufferClass::WriteLockClass lockIdxBuffer(m_roadTypes[m_curRoadType].getIB(), s_dynamic?NATIVE_BUFFER_LOCK_DISCARD:0);
	DX8VertexBufferClass::WriteLockClass lockVtxBuffer(m_roadTypes[m_curRoadType].getVB(), s_dynamic?NATIVE_BUFFER_LOCK_DISCARD:0);
