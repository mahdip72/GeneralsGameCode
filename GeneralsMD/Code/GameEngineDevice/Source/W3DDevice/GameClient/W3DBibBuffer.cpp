...
void W3DBibBuffer::loadBibsInVertexAndIndexBuffers()
{
	...
	UnsignedShort *ib;
	// Lock the buffers.
	DX8IndexBufferClass::WriteLockClass lockIdxBuffer(m_indexBib, NATIVE_BUFFER_LOCK_DISCARD);
	DX8VertexBufferClass::WriteLockClass lockVtxBuffer(m_vertexBib, NATIVE_BUFFER_LOCK_DISCARD);
