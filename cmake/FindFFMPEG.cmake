...
if(FFMPEG_FOUND)
    ...
    if(WIN32)
        ...
        elseif(RTS_FFMPEG_AUTO_RUNTIME_DIR)
            file(REAL_PATH "${FFMPEG_RUNTIME_DIR}" _FFMPEG_CURRENT_RUNTIME_DIR)
            file(REAL_PATH "${RTS_FFMPEG_AUTO_RUNTIME_DIR}" _FFMPEG_PREVIOUS_AUTO_RUNTIME_DIR)
            if(_FFMPEG_CURRENT_RUNTIME_DIR STREQUAL _FFMPEG_PREVIOUS_AUTO_RUNTIME_DIR)
                set(_FFMPEG_USE_AUTO_RUNTIME_DIR TRUE)
            endif()
        elseif(_FFMPEG_PREVIOUS_SDK_ROOT)
            file(REAL_PATH "${FFMPEG_RUNTIME_DIR}" _FFMPEG_CURRENT_RUNTIME_DIR)
            file(REAL_PATH "${_FFMPEG_PREVIOUS_SDK_ROOT}/bin" _FFMPEG_PREVIOUS_AUTO_RUNTIME_DIR)
            if(_FFMPEG_CURRENT_RUNTIME_DIR STREQUAL _FFMPEG_PREVIOUS_AUTO_RUNTIME_DIR)
                set(_FFMPEG_USE_AUTO_RUNTIME_DIR TRUE)
            endif()
        endif()
